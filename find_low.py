...
def calculate_ma(df_ticker_data):
    ...
    lowest = dt_months_sorted.head(1)
    hihgest = dt_months_sorted
...
for current_ticker in all_ticker:
    ...
    if(not math.isnan(ma100) and not math.isnan(ma200)):
        pct_ma30_diff = pct_diff(ma30,ma10)
        if pct_ma30_diff < 5:
            print('{} - diff {} - ma30 {} - ma10 {} '            print('{} - diff {} - ma100 {} - ema8 {} - {}'.format(current_ticker,diff,ma100,ema8,last_ma100))
            print('{} - diff {} - ma100 {} - ema8 {} - {}'.format(current_ticker,diff,ma100,ema8,last_ma100))
 .format(current_ticker,pct_ma30_diff,ma30,ma10))
